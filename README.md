...
- A **BlogPen** using React, Hono and Cloudflare
- A **Noter** where students can share notes and study materials

👥 **I'm looking to collaborate on:**
- Open-source projects related to **Next.js, MERN stack, Prisma, PostgreSQL**
- Hackathons & problem-solving competitions
- AI/ML-based projects, especially **NLP applications**

🤝 **I'm looking for help with:**
- Enhancing real-time chat performance with **Socket.io**
- Best practices for **NextAuth authentication flows**

🌱 **I'm currently learning:**
- **Cloudflare Workers & Cloudflare R2** for serverless applications & object management
- **TurboRepo** for efficient monorepo management
- **EAS (Expo Application Services)** for React Native apps

💬 **Ask me about:**
- **Full-stack development (Next.js, MERN, Prisma, PostgreSQL)**
- **Hackathons and GSoC preparation**
- **AI/ML and its applications in web development**
